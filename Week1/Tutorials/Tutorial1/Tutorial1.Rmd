...
* Make a table of the correlations between each predictor variable and "DEXfat", ranked from largest (in magnitude) to small (in magnitude). Which predictor variables are most correlated with "DEXfat"?
